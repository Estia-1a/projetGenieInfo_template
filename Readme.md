...
**estia-image**
- Download the `estia-image` zip file correponding to your setup (e.g., VS Code, Windows 10, with mingw 64 bits: [estia-image-v3.0.1-win10-mingw64.zip](https://github.com/Estia-1a/projetGenieInfo_public/releases/download/v2.0.1/estia-image-v2.0.1-win10-mingw64.zip))
- Unzip the file
- Move the `estia-image/` folder in your project (near `src/`)

**getopt**
- Download the `getopt` zip file correponding to your setup (e.g., VS Code, Windows 10, with mingw 64 bits: [getopt-v3.0.1-win10-mingw64.zip](https://github.com/Estia-1a/projetGenieInfo_public/releases/download/v2.0.1/getopt-v2.0.1-win10-mingw64.zip))
- Unzip the file
